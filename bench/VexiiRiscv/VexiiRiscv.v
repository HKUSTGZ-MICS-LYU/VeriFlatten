...
// Git hash  : 0c707685dfa1d40bb67a4027a2c835dc21163cbf
...
module VexiiRiscv (
  ...
  wire                when_LsuCachelessPlugin_l217;
  ...
  wire                when_LsuCachelessPlugin_l222;
  ...
  wire                when_LsuCachelessPlugin_l263;
  wire                when_LsuCachelessPlugin_l269;
  wire                when_LsuCachelessPlugin_l276;
  wire                when_LsuCachelessPlugin_l317;
  ...
  wire                when_FetchCachelessPlugin_l146;
  ...
  wire                when_FetchCachelessPlugin_l161;
  reg                 FetchCachelessPlugin_logic_join_trapSent;
  wire                when_FetchCachelessPlugin_l180;
  wire                when_FetchCachelessPlugin_l186;
  wire                when_FetchCachelessPlugin_l211;
  wire                fetch_logic_ctrls_1_haltRequest_FetchCachelessPlugin_l213;
  ...
  wire       [32:0]   _zz_FetchCachelessPlugin_logic_join_rsp_error_1;
  reg        [32:0]   _zz_FetchCachelessPlugin_logic_join_rsp_error_2;
  `ifndef SYNTHESIS
  ...
  assign _zz_CsrAccessPlugin_logic_fsm_readLogic_csrValue_8 = 32'h40001104;
  ...
  always @(*) begin
    ...
    if(when_LsuCachelessPlugin_l317) begin
      execute_ctrl2_COMMIT_lane0_bypass = 1'b0;
    end
    case(CsrAccessPlugin_logic_fsm_stateReg)
  ...
  always @(*) begin
    ...
    if(!when_FetchCachelessPlugin_l146) begin
  ...
  assign FetchCachelessPlugin_logic_buffer_reserveId_willOverflowIfInc = 1'b1;
  ...
  assign FetchCachelessPlugin_logic_buffer_reservedHits_0 = (fetch_logic_ctrls_1_up_isValid && 1'b1);
  assign FetchCachelessPlugin_logic_buffer_full = ((|FetchCachelessPlugin_logic_buffer_reservedHits_0) || FetchCachelessPlugin_logic_buffer_inflight_0);
  always @(*) begin
  ...
  always @(*) begin
    ...
    if(when_LsuCachelessPlugin_l263) begin
      LsuCachelessPlugin_logic_onFork_skip = 1'b1;
    end
    if(when_LsuCachelessPlugin_l269) begin
      LsuCachelessPlugin_logic_onFork_skip = 1'b1;
    end
    if(when_LsuCachelessPlugin_l276) begin
      LsuCachelessPlugin_logic_onFork_skip = 1'b1;
    end
  ...
  assign when_LsuCachelessPlugin_l217 = (! execute_freeze_valid);
  ...
  assign when_LsuCachelessPlugin_l222 = (! execute_freeze_valid);
  ...
  assign when_LsuCachelessPlugin_l263 = ((execute_ctrl2_down_AguPlugin_LOAD_lane0 && execute_ctrl2_down_LsuCachelessPlugin_logic_onPma_RSP_lane0_io) && 1'b0);
  assign when_LsuCachelessPlugin_l269 = ((execute_ctrl2_down_MMU_ACCESS_FAULT_lane0 || execute_ctrl2_down_LsuCachelessPlugin_logic_onPma_RSP_lane0_fault) || execute_ctrl2_down_LsuCachelessPlugin_logic_pmpPort_ACCESS_FAULT_lane0);
  assign when_LsuCachelessPlugin_l276 = (execute_ctrl2_down_MMU_PAGE_FAULT_lane0 || (execute_ctrl2_down_AguPlugin_STORE_lane0 ? (! execute_ctrl2_down_MMU_ALLOW_WRITE_lane0) : (! execute_ctrl2_down_MMU_ALLOW_READ_lane0)));
  assign when_LsuCachelessPlugin_l317 = ((execute_ctrl2_up_LANE_SEL_lane0 && execute_ctrl2_down_AguPlugin_SEL_lane0) && LsuCachelessPlugin_logic_onFork_skip);
  ...
  assign when_FetchCachelessPlugin_l146 = ((fetch_logic_ctrls_0_down_MMU_HAZARD || fetch_logic_ctrls_0_down_MMU_REFILL) || fetch_logic_ctrls_0_down_FetchCachelessPlugin_logic_fork_PMA_FAULT);
  always @(*) begin
    FetchCachelessPlugin_logic_join_haltIt = FetchCachelessPlugin_logic_buffer_inflight_0;
    if(when_FetchCachelessPlugin_l161) begin
      FetchCachelessPlugin_logic_join_haltIt = 1'b0;
    end
  end

  assign _zz_FetchCachelessPlugin_logic_join_rsp_error = _zz_FetchCachelessPlugin_logic_join_rsp_error_1;
  always @(*) begin
  ...
  assign when_FetchCachelessPlugin_l161 = (FetchCachelessPlugin_logic_bus_rsp_valid && 1'b1);
  assign fetch_logic_ctrls_1_down_Fetch_WORD = FetchCachelessPlugin_logic_join_rsp_word;
  always @(*) begin
    fetch_logic_ctrls_1_down_TRAP = 1'b0;
    if(when_FetchCachelessPlugin_l180) begin
      fetch_logic_ctrls_1_down_TRAP = 1'b1;
    end
    if(when_FetchCachelessPlugin_l186) begin
      fetch_logic_ctrls_1_down_TRAP = 1'b1;
    end
    ...
    if(when_FetchCachelessPlugin_l211) begin
      fetch_logic_ctrls_1_down_TRAP = 1'b0;
    end
  end
  ...
  assign _zz_4 = zz_FetchCachelessPlugin_logic_trapPort_payload_arg(1'b0);
  always @(*) FetchCachelessPlugin_logic_trapPort_payload_arg = _zz_4;
  assign when_FetchCachelessPlugin_l180 = ((FetchCachelessPlugin_logic_join_rsp_error || fetch_logic_ctrls_1_down_FetchCachelessPlugin_logic_fork_PMA_FAULT) || fetch_logic_ctrls_1_down_FetchCachelessPlugin_logic_pmpPort_ACCESS_FAULT);
  assign when_FetchCachelessPlugin_l186 = (fetch_logic_ctrls_1_down_MMU_PAGE_FAULT || (! fetch_logic_ctrls_1_down_MMU_ALLOW_EXECUTE));
  assign when_FetchCachelessPlugin_l211 = ((! fetch_logic_ctrls_1_up_isValid) || FetchCachelessPlugin_logic_join_haltIt);
  assign fetch_logic_ctrls_1_haltRequest_FetchCachelessPlugin_l213 = FetchCachelessPlugin_logic_join_haltIt;
  ...
  assign when_CtrlLink_l191_1 = (|fetch_logic_ctrls_1_haltRequest_FetchCachelessPlugin_l213);
  ...
  assign _zz_FetchCachelessPlugin_logic_join_rsp_error_1 = _zz_FetchCachelessPlugin_logic_join_rsp_error_2;
  always @(posedge clk) begin
    ...
    if(when_Phase_l774) begin
      _zz_FetchCachelessPlugin_logic_join_rsp_error_2 <= {FetchCachelessPlugin_logic_buffer_write_payload_data_word,FetchCachelessPlugin_logic_buffer_write_payload_data_error};
    end
  end
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      if(when_LsuCachelessPlugin_l217) begin
      ...
      if(when_LsuCachelessPlugin_l222) begin
        LsuCachelessPlugin_logic_onFork_cmdSent <= 1'b0;
      end
      ...
      `ifndef SYNTHESIS
        `ifdef FORMAL
          assert((! ((((execute_ctrl3_up_LANE_SEL_lane0 && execute_lane0_ctrls_3_upIsCancel) && execute_ctrl3_down_AguPlugin_SEL_lane0) && execute_ctrl3_down_AguPlugin_STORE_lane0) && (! execute_ctrl3_up_TRAP_lane0)))); // LsuCachelessPlugin.scala:L382
        `else
          if(!(! ((((execute_ctrl3_up_LANE_SEL_lane0 && execute_lane0_ctrls_3_upIsCancel) && execute_ctrl3_down_AguPlugin_SEL_lane0) && execute_ctrl3_down_AguPlugin_STORE_lane0) && (! execute_ctrl3_up_TRAP_lane0)))) begin
            $display("FAILURE LsuCachelessPlugin saw unexpected select && STORE && cancel request"); // LsuCachelessPlugin.scala:L382
            $finish;
          end
        `endif
      `endif
      ...
      if(FetchCachelessPlugin_logic_bus_cmd_isStall_regNext) begin
        `ifndef SYNTHESIS
          `ifdef FORMAL
            assert((1'b1 && (FetchCachelessPlugin_logic_bus_cmd_payload_address == FetchCachelessPlugin_logic_bus_cmd_payload_regNext_address))); // Stream.scala:L662
          `else
            if(!(1'b1 && (FetchCachelessPlugin_logic_bus_cmd_payload_address == FetchCachelessPlugin_logic_bus_cmd_payload_regNext_address))) begin
              $display("FAILURE Stream payload persistence failed"); // Stream.scala:L662
              $finish;
            end
          `endif
